...
const STATUS_ICON: Record<string, any> = {
  pending: Clock, completed: CheckCircle, paid: CheckCircle, failed: XCircle,
  refunded: XCircle, shipped: Truck, delivered: CheckCircle,
  in_production: Package, submitted: Package, canceled: XCircle,
};

const STATUS_COLOR: Record<string, string> = {
  completed: "text-green-400", paid: "text-green-400", pending: "text-yellow-400",
  failed: "text-red-400", refunded: "text-purple-400", shipped: "text-green-400",
  delivered: "text-green-400", in_production: "text-blue-400",
  submitted: "text-blue-400", canceled: "text-red-400",
};
