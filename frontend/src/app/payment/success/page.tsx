    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="flex flex-col gap-3">
          {type === "merch" && (
            <Link href="/track-order" className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-colors">
          ...
          <Link href="/" className="inline-flex items-center justify-center gap-2 text-muted-foreground hover:text-foreground transition-colors">
