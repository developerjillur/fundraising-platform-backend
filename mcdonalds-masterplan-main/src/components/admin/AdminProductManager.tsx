        ...
        <AlertDialogContent className="bg-card border-border">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-muted-foreground space-y-2">
              ...
              <p className="text-accent font-medium">⚠️ Products that were previously synced will be overwritten with data from Printful (name, price, image, variants). Manually edited details on those products will be lost.</p>
